# R code for the project pregnancy complications
...
The data consists of Swedish, Dutch and Irish individual patient data and therefore no data is stored in this repository. 
